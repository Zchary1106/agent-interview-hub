...
| 14 | [Java 后端工程师岗位指南与知识地图](通用知识/Java后端工程师岗位指南与知识地图.md) | 岗位要求、能力要求 → 知识地图与 4 周准备路线 🆕 |
| 15 | [Java 核心基础：语言集合异常 JVM 并发](通用知识/Java核心基础-语言集合异常JVM并发.md) | 集合选型、JVM 内存与 GC、并发工具与高频面试题 🆕 |
| 16 | [Java 数据库与缓存：MySQL 事务索引 Redis](通用知识/Java数据库与缓存-MySQL事务索引Redis.md) | B+ 树索引、事务隔离、缓存一致性方案与面试题 🆕 |
| 17 | [Java 分布式与微服务：消息队列系统设计](通用知识/Java分布式与微服务-消息队列系统设计.md) | 微服务、分布式事务、MQ 可靠性、限流熔断与秒杀设计 🆕 |
| 18 | [Java 项目表达：架构指标故障与技术取舍](通用知识/Java项目表达-架构指标故障与技术取舍.md) | STAR 表达框架、技术取舍话术、故障复盘模板 🆕 |

### 📝 面试题库

| # | 文档 | 简介 |
|---|------|------|
| 19 | [最新 AI Agent 面经索引（2026）](通用知识/最新AI-Agent面经索引.md) | 牛客、小红书、知乎、CSDN、GitHub 等公开来源的最新面经入口 |
| 20 | [核心概念详解与参考答案](通用知识/核心概念详解与参考答案.md) | 高频概念题精讲与标准答案 |
| 21 | [八股文完整答案集](通用知识/八股文完整答案集.md) | 69 道八股题，全部附详细解答 |
| 22 | [八股文题库 - DataWhale 开源](通用知识/八股文题库-DataWhale开源.md) | DataWhale 社区精选题库 |
| 23 | [高频拷打题 - 牛客热帖](通用知识/高频拷打题-牛客热帖.md) | 牛客论坛高赞面试拷打合集 |
| 24 | [技术知识点汇总](通用知识/技术知识点汇总.md) | 速查手册：关键知识点一网打尽 |
| 25 | [其他公司面经 - 快手携程等](通用知识/其他公司面经-快手携程等.md) | 快手、携程等公司面经补充 |

### 🌐 进阶面试题

| # | 文档 | 简介 |
|---|------|------|
| 26 | [Agent 核心概念面试题 - 进阶篇](通用知识/Agent核心概念面试题-进阶篇.md) | 核心概念高频问答进阶版 |
| 27 | [系统设计面试题 - 进阶篇](通用知识/系统设计面试题-进阶篇.md) | 系统设计题与参考答案进阶版 |
| 28 | [AI 协作与工程化面试题 - 进阶篇](通用知识/AI协作与工程化面试题-进阶篇.md) | AI 协作工程化问答进阶版 |
| 29 | [交互式面试算法题图谱](https://zchary1106.github.io/agent-interview-hub/%E9%9D%A2%E8%AF%95%E7%AE%97%E6%B3%95%E9%A2%98/) | 近期公开 Agent / 大模型面经算法题，附可折叠 Java 解法 |
