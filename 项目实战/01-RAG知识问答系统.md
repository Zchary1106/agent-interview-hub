...
![RAG 混合检索与生成链路](../diagrams/rag-hybrid-retrieval-flow.svg)

### 离线数据摄入流

![RAG 文档入库流水线](../diagrams/document-ingestion-pipeline.svg)
...
**回答**：
> ![RAG 系统部署拓扑](../diagrams/rag-deployment-topology.svg)
>
