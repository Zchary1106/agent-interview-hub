...
| 牛客 | [字节跳动 Agent 开发近期面经汇总（2026-08）](https://www.nowcoder.com/discuss/922659050167226368) | Harness/Orchestrator、路径震荡、长上下文、工具检索、Coding Agent 并发、生产评测 |
| 牛客 | [字节跳动 9.3 Agent 开发一面面经](https://www.nowcoder.com/discuss/925342611194286080) | Harness、长任务延迟排查、工具参数可靠性、上下文压缩、结构化评分 |
| 牛客 | [字节 Agent 开发一面（8.12）](https://www.nowcoder.com/discuss/921444774287003648) | RAG、AI Coding 质量控制、SSE/WebSocket、高并发、数据库索引、线程安全 |
...
9. Harness、Orchestrator 和 Runtime 分别负责什么？为什么不能都塞进 Agent Loop？
10. Agent 在多个失败方案之间反复切换时，如何检测路径震荡并强制产生新计划？
11. 当工具数量扩展到数百个时，如何做权限过滤、候选检索和 Schema 精排？
12. 多个 Coding Agent 并行修改仓库时，如何隔离工作区、合并补丁并重新验证？
13. 长任务突然变慢时，如何区分模型延迟、上下文膨胀、工具阻塞和重试风暴？
14. 模型输出 1-5 分等结构化结果时，怎样确保格式合法、理由与分数一致并可回归测试？
...
- https://www.nowcoder.com/discuss/921444774287003648
